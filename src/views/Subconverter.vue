...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub.proxypoolv2.tk (Allen Xu提供-稳定)": "https://sub.proxypoolv2.tk/sub?",
          "api.tsutsu.cc (つつ提供-不是很稳定）": "http://api.tsutsu.cc:520/sub?",
  ...
  mounted() {
    ...
    this.form.customBackend = "https://api.hope140.live/sub?";
